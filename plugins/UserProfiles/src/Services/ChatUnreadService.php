...
namespace Plugins\UserProfiles\Services;
...
use Plugins\UserProfiles\Models\ChatReadCursor;
...
class ChatUnreadService
{
    ...
    public static function markAsRead(User $user, Friendship $friendship, ?int $maxMessageId = null): void
    {
        ...
        ChatReadCursor::query()->updateOrCreate(
            [
                'user_id' => $user->id,
    ...
    public static function unreadCountForFriendship(User $user, int $friendshipId): int
    {
        ...
        $lastRead = (int) ChatReadCursor::query()
