...
<body class="bg-gray-50 dark:bg-dark-900 text-gray-900 dark:text-gray-100 min-h-screen">
    ...
    @endphp
    <!-- Navigation -->
    <nav class="sticky top-0 z-50 bg-white/80 dark:bg-dark-800/80 backdrop-blur-lg border-b border-gray-200 dark:border-dark-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <a href="{{ url('/') }}" class="flex items-center gap-2">
                    ...
                    @else
                        <div class="w-10 h-10 bg-gradient-to-br from-primary-500 to-purple-500 rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/25">
                ...
                <div class="hidden md:flex items-center gap-1">
                    ...
                    @auth
                        @if(\Illuminate\Support\Facades\Route::has('profiles.index'))
                            <a href="{{ route('profiles.index') }}" class="{{ $desktopNavClasses(str_starts_with($currentRouteName, 'profiles.')) }}">
        ...
        <div id="mobileMenu" class="hidden md:hidden border-t border-gray-200 dark:border-dark-700">
            <div class="px-4 py-4 space-y-2">
                ...
                @auth
                    @if(\Illuminate\Support\Facades\Route::has('profiles.index'))
                        <a href="{{ route('profiles.index') }}" class="{{ $mobileNavClasses(str_starts_with($currentRouteName, 'profiles.')) }}">
                            <i class="fas fa-user-group mr-2"></i>{{ __('Members') }}
                        </a>
                    @endif
                @endauth
    ...
    <!-- Footer -->
    <footer class="bg-white dark:bg-dark-800 border-t border-gray-200 dark:border-dark-700 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-4">{{ __('Your trusted source for the latest news and updates.') }}</p>
                    @php
                        $socialLinks = [
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="{{ route('legal.imprint') }}" class="text-gray-600 dark:text-gray-400 hover:text-primary-500 transition-colors">{{ __('legal.imprint.page_title') }}</a></li>
                        <li><a href="{{ route('legal.privacy') }}" class="text-gray-600 dark:text-gray-400 hover:text-primary-500 transition-colors">{{ __('legal.privacy.page_title') }}</a></li>
                        <li><a href="{{ route('legal.terms') }}" class="text-gray-600 dark:text-gray-400 hover:text-primary-500 transition-colors">{{ __('legal.terms.page_title') }}</a></li>
                    ...
                    <ul class="space-y-2">
                        ...
                        @if (! $hasContactRow)
                            <li class="flex items-start gap-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                <a href="{{ route('legal.imprint') }}" class="hover:text-primary-500 transition-colors">{{ __('Contact details in imprint') }}</a>
                            </li>
                        @endif
                    </ul>
                </div>
            ...
            <div class="mt-12 pt-8 border-t border-gray-200 dark:border-dark-700 flex flex-col md:flex-row items-center justify-between gap-4">
                <p class="text-gray-600 dark:text-gray-400 text-sm text-center md:text-left">
                    ...
                    <a href="{{ route('legal.imprint') }}" class="hover:text-primary-500 transition-colors">{{ __('legal.imprint.page_title') }}</a>
                    <span class="mx-2 text-gray-400">·</span>
                    <a href="{{ route('legal.privacy') }}" class="hover:text-primary-500 transition-colors">{{ __('legal.privacy.page_title') }}</a>
                    <span class="mx-2 text-gray-400">·</span>
                    <a href="{{ route('legal.terms') }}" class="hover:text-primary-500 transition-colors">{{ __('legal.terms.page_title') }}</a>
                    <span class="mx-2 text-gray-400">·</span>
